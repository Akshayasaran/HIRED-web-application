                    ...
                    <div class="col-lg-12">
                        <div class="card h-100">
                            ...
                            <div class="card-body bg-light pb-0">
                                <form class="row g-3 needs-validation" novalidate="" action="<%= request.getContextPath()%>/ServiceUpdate" method="POST" >
                                    <input type="hidden" id="service-operation" name="service-operation" value="<%= serviceOperation%>"/>
                                    <input type="hidden" id="user-id" name="user-id" value="<%= loginUser%>"/>
                                    <div class="mb-3"><label class="form-label" for="service-name">Service</label>
                                        <select class="form-select" name="service-id" id="service-id" required="">
                                            ...
                                            <option
                                                <% if (availableService != null && service.getServiceId().equals(availableService.getServiceId())) { %>
                                                selected
                                                <%  }%>
                                                value="<%= service.getServiceId()%>"><%= service.getServiceName()%></option>
                                    ...
                                    <div class="row g-2 mt-2">
                                        <div class="col-6 mb-3"><label class="form-label" for="service-time-from">Time From</label>
                                            <input class="form-control datetimepicker" id="service-time-from" name="service-time-from"
                                                   type="text" placeholder="H:i" required="required"

                                                   <% if (availableService != null) {%>
                                                   value="<%= availableService.getTimeFrom()%>"                                                          
                                                   <% } %>

                                                   data-options='{"enableTime":true,"noCalendar":true,"dateFormat":"H:i","disableMobile":true}' />
                                            <div class="invalid-feedback">Please select a time.</div>
                                        </div>
                                        <div class=" col-6 mb-3"><label class="form-label" for="service-time-to">Time To</label>
                                            <input class="form-control datetimepicker" id="service-time-to" name="service-time-to" type="text"
                                                   placeholder="H:i" required="required"

                                                   <% if (availableService != null) {%>
                                                   value="<%= availableService.getTimeTo()%>"                                                          
                                                   <% } %>
                                    ...
                                    <div class="mb-3"><label class="form-label" for="service-date">Working Days</label>
                                        <div>
                                            ...
                                            <div class="form-check form-check-inline"><input class="form-check-input" name="day-of-week-<%= i%>"
                                                                                             id="day-of-week-<%= i%>" type="checkbox" value="<%= weekDays[i - 1]%>"

                                                                                             <% if (availableService != null && availableService.getWorkingDays().charAt(i - 1) == '1') {
                                                                                             %>
                                                                                             checked="checked"                                                            
                                                                                             <%
                                                                                                 }
                                                                                             ...
                                                                                             for="day-of-week-<%= i%>"><%= weekDays[i - 1]%></label></div>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check mb-0 lh-1 form-check form-switch"><input class="form-check-input"type="checkbox" value="available" name="service-availability" id="service-availability" 
                                                                                                        <% if (availableService != null && availableService.isAvailability()) {
                                                                                                        %>
                                                                                                        checked="checked"                                                            
                                                                                                        <%
                                                                                                            }
                                                                                                        %>                                                                                                        
                                                                                                        >
                                            <label class="form-check-label mb-0" for="service-availability">Available</label></div>
                                    </div>
                                        ...
                                        <div class="row g-2 mt-2">
                                            ...
                                            <div class="col-6">
                                                <button class="btn btn-primary d-block w-100 mt-3" type="submit"
                                                        name="update-service-button">Update</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
