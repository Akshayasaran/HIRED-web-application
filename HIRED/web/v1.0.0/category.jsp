                                ...
                                <div class="navbar-vertical-content scrollbar">
                                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link active" href="<%=request.getContextPath()%>/v1.0.0/category.jsp"
                                                role="button">
                                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body position-relative">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h3>Categories</h3>
                                    <p>Choose the Service you're looking for</p>
                                </div>
                            </div>
                        </div>
                        <!--                    </div>
                                        ...
                                        <%
                                            try {
                                                ...
                                                for (Category category : categories) {
                                                    ArrayList<Service> services = Service.getServiceByCategory(category.getCategoryId());
                                        %>
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="heading<%=index%>"><button class="accordion-button collapsed" type="button"
                                                                                                        data-bs-toggle="collapse" data-bs-target="#collapse<%=index%>" aria-expanded="false"
                                                                                                        aria-controls="collapse<%=index%>"><%= category.getCategoryName()%></button></h2>
                                            <div class="accordion-collapse collapse" id="collapse<%=index%>" aria-labelledby="heading<%=index%>"
                                                ...
                                                <div class="accordion-body accordian-item-border">
                                                    
                                                    <a href="<%=request.getContextPath()%>/v1.0.0/search.jsp?query=<%= service.getServiceName() %>" ><%= service.getServiceName()%></a>
