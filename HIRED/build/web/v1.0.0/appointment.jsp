...
<html lang="en-US" dir="ltr">
    ...
    <!-- Mirrored from prium.github.io/falcon/v3.0.0-beta4/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Mar 2021 07:26:20 GMT -->
    <!-- Added by HTTrack -->
    ...
    <body>
        ...
        <%
            ...
            ArrayList<Appointment> bookedAppointments = null;
            ArrayList<Appointment> requestedAppointments = null;

            bookedAppointments = Appointment.getAppointmentByReceiver(loginUser);
            requestedAppointments = Appointment.getAppointmentByProvider(loginUser);
                        ...
                        <div class="navbar-vertical-content scrollbar">
                            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                                ...
                                <li class="nav-item">
                                                        ...
                                                        <div class="col-12">
                                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                                <li class="nav-item"><a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="#tab-home"
                                                                                        role="tab" aria-controls="tab-home" aria-selected="false">Booked</a></li>
                                                                <li class="nav-item"><a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#tab-profile"
                                                                                        role="tab" aria-controls="tab-profile" aria-selected="false">Request</a></li>
                                                            </ul>
                                                            <div class="tab-content border-x border-bottom p-3" id="myTabContent">
                                                                <div class="tab-pane fade active show " id="tab-home" role="tabpanel" aria-labelledby="home-tab">
                                                                    ...
                                                                    <div style="float: right" class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none" type="button" id="dropdown-weather-update" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><svg class="svg-inline--fa fa-ellipsis-h fa-w-16 fs--2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis-h" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M328 256c0 39.8-32.2 72-72 72s-72-32.2-72-72 32.2-72 72-72 72 32.2 72 72zm104-72c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72zm-352 0c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72z"></path></svg><!-- <span class="fas fa-ellipsis-h fs--2"></span> Font Awesome fontawesome.com --></button>
                                                                        <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-weather-update" style="margin: 0px;">
                                                                            <a class="dropdown-item" href="<%=request.getContextPath()%>/v1.0.0/social/profile.jsp?profileid=<%= appointment.getServiceProviderId()%>">View Profile</a>

                                                                            <form method="POST" action="<%=request.getContextPath()%>/v1.0.0/appointment-book.jsp">
                                                                                <input type="hidden" name="provider-id" id="provider-id" value="<%= appointment.getServiceProviderId()%>"/>
                                                                                <input type="hidden" name="provider-name" id="provider-name" value="<%= appointment.getServiceProviderName()%>"/>
                                                                                <input type="hidden" name="service-id" id="service-id" value="<%= appointment.getServiceId()%>"/>
                                                                                <input type="hidden" name="service-name" id="service-name" value="<%= appointment.getServiceName()%>"/>
                                                                                <input type="hidden" name="appointment-operation" id="appointment-operation" value="modify"/>
                                                                                <button class="dropdown-item" type="submit" >Edit Appointment</button>
                                                                            </form>

                                                                            <form method="POST" action="<%=request.getContextPath()%>/BookAppointment">
                                                                                <input type="hidden" name="receiver-id" id="receiver-id" value="<%= loginUser%>"/>
                                                                                <input type="hidden" name="service-provider-id" id="service-provider-id" value="<%= appointment.getServiceProviderId()%>"/>
                                                                                <input type="hidden" name="service-id" id="service-id" value="<%= appointment.getServiceId()%>"/>
                                                                                <input type="hidden" name="appointment-operation" id="appointment-operation" value="delete"/>
                                                                                <button class="dropdown-item" type="submit" >Delete Appointment</button>
                                                                            </form>
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="flex-1 position-relative ps-3">
                                                                            <h2 class="fs-2 fw-bold font-sans-serif text-700 lh-1 mb-1"><%= appointment.getServiceProviderName()%></h2>
                                                                            <h6 class="fs-0 mb-0"><%= appointment.getServiceName()%></h6>

                                                                        </div>
                                                                        <div class="flex-1 position-relative ps-3">
                                                                            <h6 class="fs-0 mb-0"><%= appointment.getTime()%></h6>
                                                                            <h6 class="fs-0 mb-0"><%= appointment.getDate()%></h6>

                                                                        </div>
                                                                        <div class="flex-1 position-relative ps-3">
                                                                            <h2 class="fs-1 fw-bold font-sans-serif text-700 lh-1 mb-1">
                                                                                <%
                                                                                String colorString = "secondary";
                                                                                if (appointment.getStatus().equals(Appointment.ACCEPT))
                                                                                    colorString = "success";
                                                                                else if (appointment.getStatus().equals(Appointment.PENDING))
                                                                                    colorString = "warning";
                                                                                else if (appointment.getStatus().equals(Appointment.REJECT))
                                                                                    colorString = "danger";
                                                                                %>
                                                                                <span class="badge rounded-pill bg-<%= colorString %>"><%= appointment.getStatus()%></span></h2>
                                                                        </div>
                                                                ...
                                                                <div class="tab-pane fade" id="tab-profile" role="tabpanel" aria-labelledby="profile-tab">
                                                                    ...
                                                                    <%
                                                                        if (requestedAppointments != null && requestedAppointments.size() > 0) {
                                                                    ...
                                                                    <div style="float: right" class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none" type="button" id="dropdown-weather-update" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><svg class="svg-inline--fa fa-ellipsis-h fa-w-16 fs--2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis-h" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M328 256c0 39.8-32.2 72-72 72s-72-32.2-72-72 32.2-72 72-72 72 32.2 72 72zm104-72c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72zm-352 0c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72z"></path></svg><!-- <span class="fas fa-ellipsis-h fs--2"></span> Font Awesome fontawesome.com --></button>
                                                                        <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-weather-update" style="margin: 0px;">
                                                                            ...
                                                                            <a class="dropdown-item" href="<%=request.getContextPath()%>/v1.0.0/social/profile.jsp?profileid=<%= appointment.getServiceReceiverId()%>">View Profile</a>

                                                                            <form method="POST" action="<%=request.getContextPath()%>/BookAppointment">
                                                                                <input type="hidden" name="receiver-id" id="receiver-id" value="<%= appointment.getServiceReceiverId()%>"/>
                                                                                <input type="hidden" name="service-provider-id" id="service-provider-id" value="<%= loginUser%>"/>
                                                                                <input type="hidden" name="service-id" id="service-id" value="<%= appointment.getServiceId()%>"/>
                                                                                <input type="hidden" name="appointment-respond" id="appointment-respond" value="<%= Appointment.ACCEPT%>"/>
                                                                                <input type="hidden" name="appointment-operation" id="appointment-operation" value="respond"/>
                                                                                <button class="dropdown-item" type="submit" >Accept Appointment</button>
                                                                            </form>
                                                                            ...
                                                                            <form method="POST" action="<%=request.getContextPath()%>/BookAppointment">
                                                                                ...
                                                                                <input type="hidden" name="service-provider-id" id="service-provider-id" value="<%= loginUser%>"/>
                                                                                <input type="hidden" name="service-id" id="service-id" value="<%= appointment.getServiceId()%>"/>
                                                                                <input type="hidden" name="appointment-respond" id="appointment-respond" value="<%= Appointment.REJECT%>"/>
                                                                                <input type="hidden" name="appointment-operation" id="appointment-operation" value="respond"/>
                                                                                <button class="dropdown-item" type="submit" >Reject Appointment</button>
                                                                            </form> 
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="flex-1 position-relative ps-3">
                                                                            <h2 class="fs-2 fw-bold font-sans-serif text-700 lh-1 mb-1"><%= appointment.getServiceReceiverName()%></h2>
                                                                            <h6 class="fs-0 mb-0"><%= appointment.getServiceName()%></h6>
                                                                        ...
                                                                        <div class="flex-1 position-relative ps-3">
                                                                            <h2 class="fs-2 fw-bold font-sans-serif text-700 lh-1 mb-1">
                                            ...
                                            <div class="modal-content border-0 vh-100 scrollbar-overlay">
                                                <div class="modal-header modal-header-settings bg-shape">
                                                    <div class="z-index-1 py-1 light">
                                                        <h5 class="text-white" id="settings-modal-label"> <span class="fas fa-palette me-2 fs-0"></span>Settings
                                                        </h5>
                                                        <p class="mb-0 fs--1 text-white opacity-75"> Set your own customized style</p>
                                                    </div><button class="btn-close btn-close-white z-index-1 mt-0" type="button" data-bs-dismiss="modal"
                                                ...
                                                <div class="modal-body px-card" id="themeController">
                                                    ...
                                                    <div class="btn-group d-block w-100 btn-group-navbar-style">
                                                        <div class="row gx-2">
                                                            <div class="col-6"><input class="btn-check" id="themeSwitcherLight" name="theme-color" type="radio"
                                                                                      value="light" data-theme-control="theme" /><label class="btn d-inline-block btn-navbar-style fs--1"
                                                                                      for="themeSwitcherLight"> <span class="hover-overlay mb-2 rounded d-block"><img
                                                                            class="img-fluid img-prototype mb-0" src="assets/img/generic/falcon-mode-default.jpg"
                                                            ...
                                                            <div class="col-6"><input class="btn-check" id="themeSwitcherDark" name="theme-color" type="radio"
                                                                                      value="dark" data-theme-control="theme" /><label class="btn d-inline-block btn-navbar-style fs--1"
                                                                                      for="themeSwitcherDark"> <span class="hover-overlay mb-2 rounded d-block"><img
                                                                            class="img-fluid img-prototype mb-0" src="assets/img/generic/falcon-mode-dark.jpg"
                                                        ...
                                                        <div class="d-flex align-items-start"><img class="me-2" src="assets/img/icons/left-arrow-from-left.svg"
                                                            ...
                                                            <div class="flex-1">
                                                                ...
                                                                <p class="fs--1 mb-0">Switch your language direction </p><a class="fs--1"
                                                                                                                            href="documentation/configuration.html">RTL Documentation</a>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex align-items-start"><img class="me-2" src="assets/img/icons/arrows-h.svg" width="20"
                                                            ...
                                                            <div class="flex-1">
                                                                ...
                                                                <p class="fs--1 mb-0">Toggle container layout system </p><a class="fs--1"
                                                                                                                            href="documentation/configuration.html">Fluid Documentation</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="text-center mt-5"><img class="mb-4" src="assets/img/illustrations/settings.png" alt=""
                                                                                       width="120" />
                                    ...
                                    <!-- Mirrored from prium.github.io/falcon/v3.0.0-beta4/widgets.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Mar 2021 07:26:21 GMT -->
