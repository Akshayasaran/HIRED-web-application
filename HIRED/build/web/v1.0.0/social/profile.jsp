...
<html lang="en-US" dir="ltr">
    ...
    <body>
        ...
        <%
            ...
            profileId = (profileId == null || profileId.isEmpty()) ? loginUser : profileId;

            IProfile loginUserProfile = new IProfile();
            String profileResult = loginUserProfile.getProfile(profileId);
            if (profileResult.equals("profile_norecord") && profileId.equals(loginUser)) {
                ...
                <script>
                                ...
                                <div class="navbar-vertical-content scrollbar">
                                    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" href="<%=request.getContextPath()%>/v1.0.0/search.jsp"
                                                role="button">
                                                <div class="d-flex align-items-center"><span class="nav-link-icon"><span
                    ...
                    <div class="card mb-3">
                        <div class="card-header position-relative min-vh-25 mb-7">
                            <div class="bg-holder rounded-3 rounded-bottom-0" style="background-color: inherit;"></div>
                            <!--/.bg-holder-->
                            <div class="avatar avatar-5xl avatar-profile"><img class="rounded-circle img-thumbnail shadow-sm" src="../images/<%= IProfile.getProfileImagePath(profileId) %>" width="200" alt="" /></div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <h4 class="mb-1"><%= loginUserProfile.getAccountName()%><span data-bs-toggle="tooltip" data-bs-placement="right" title="Verified"><small class="fa fa-check-circle text-primary" data-fa-transform="shrink-4 down-2"></small></span></h4>
                                    <p class="text-500"><%= loginUserProfile.getPersonalCity()%>, <%= loginUserProfile.getPersonalState()%></p>

                                    <% if (loginUser.equals(profileId)) {%>

                                    <a href="<%= request.getContextPath()%>/v1.0.0/authentication/profilesetup.jsp?operation=modify">
                                        <button class="btn btn-falcon-default btn-sm px-3 ms-2" type="button">Edit</button>
                                    </a>
                                ...
                                <div class="col ps-2 ps-lg-3">
                                    <a class="d-flex align-items-center mb-2" href="#"><span class="fab fa-whatsapp fs-3 me-2 text-700" data-fa-transform="grow-0"></span>
                                        <div class="flex-1">
                                            <h6 class="mb-0"><%= loginUserProfile.getPersonalPhone()%></h6>
                                        </div>
                                    </a>
                                    <a class="d-flex align-items-center mb-2" href="#"><span class="fas fa-envelope fs-3 me-2 text-700" data-fa-transform="grow-0"></span>
                                        <div class="flex-1">
                                            <h6 class="mb-0"><%= loginUserProfile.getAccountEmail()%></h6>
                                        </div>
                                    </a>
                                    <!--                                    <a class="d-flex align-items-center mb-2" href="#"><img class="align-self-center me-2" src="../assets/img/logos/apple.png" alt="Generic placeholder image" width="30" />
                                                                            <div class="flex-1">
                                                                                <h6 class="mb-0">Apple</h6>
                                                                            </div>
                                                                        </a>
                                                                        <a class="d-flex align-items-center mb-2" href="#"><img class="align-self-center me-2" src="../assets/img/logos/hp.png" alt="Generic placeholder image" width="30" />
                                                                            <div class="flex-1">
                    ...
                    <div class="row g-0">
                        <div class="col-lg-8 pe-lg-2">
                            <%
                                if (loginUserProfile.getAccountSummary() != null) {
                            %>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body text-justify">
                                    ...
                                    <div class="collapse show" id="profile-intro">
                                        <p class="mt-3 text-1000"><%= loginUserProfile.getAccountSummary()%></p>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body fs--1 pb-0">
                                    <div class="card-body fs--1 pb-0">
                                        ...
                                        <a class="mb-4 d-block d-flex align-items-center collapsed" href="<%=request.getContextPath()%>/v1.0.0/service-update.jsp?operation=add"><span class="circle-dashed"><svg class="svg-inline--fa fa-plus fa-w-14" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="plus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M416 208H272V64c0-17.67-14.33-32-32-32h-32c-17.67 0-32 14.33-32 32v144H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h144v144c0 17.67 14.33 32 32 32h32c17.67 0 32-14.33 32-32V304h144c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"></path></svg><!-- <span class="fas fa-plus"></span> Font Awesome fontawesome.com --></span><span class="ms-3">Add new service</span></a>
                                        ...
                                        <%
                                            ...
                                            try {
                                                availableServices = AvailableService.searchServiceByUser(profileId);
                                            } catch (Exception e) {
                                                e.printStackTrace();
                                            }
                                        ...
                                        <div style="float: right" class="dropdown font-sans-serif btn-reveal-trigger"><button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal dropdown-caret-none" type="button" id="dropdown-weather-update" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><svg class="svg-inline--fa fa-ellipsis-h fa-w-16 fs--2" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ellipsis-h" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M328 256c0 39.8-32.2 72-72 72s-72-32.2-72-72 32.2-72 72-72 72 32.2 72 72zm104-72c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72zm-352 0c-39.8 0-72 32.2-72 72s32.2 72 72 72 72-32.2 72-72-32.2-72-72-72z"></path></svg><!-- <span class="fas fa-ellipsis-h fs--2"></span> Font Awesome fontawesome.com --></button>
                                            <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-weather-update" style="margin: 0px;">
                                                ...
                                                <form method="POST" action="<%=request.getContextPath()%>/ServiceUpdate">
                                                    <input type="hidden" name="user-id" id="user-id" value="<%= loginUser%>"/>
                                                    <input type="hidden" name="service-id" id="service-id" value="<%= service.getServiceId()%>"/>
                                                    <input type="hidden" name="service-operation" id="service-operation" value="availabilty"/>
                                                    <button class="dropdown-item" type="submit" >Change Availability</button>
                                                </form>

                                                <form method="POST" action="<%=request.getContextPath()%>/ServiceUpdate">
                                                    <input type="hidden" name="user-id" id="user-id" value="<%= loginUser%>"/>
                                                    <input type="hidden" name="service-id" id="service-id" value="<%= service.getServiceId()%>"/>
                                                    <input type="hidden" name="service-operation" id="service-operation" value="delete"/>
                                                    <button class="dropdown-item" type="submit" >Delete Service</button>
                                                </form>

                                                <form method="POST" action="<%=request.getContextPath()%>/v1.0.0/service-update.jsp">
                                                    <input type="hidden" name="user-id" id="user-id" value="<%= loginUser%>"/>
                                                    <input type="hidden" name="service-id" id="service-id" value="<%= service.getServiceId()%>"/>
                                                    ...
                                                    <button class="dropdown-item" type="submit" >Edit Service</button>
                                                </form>
...
<!--                                                <p class="text-1000 mb-0">Working Days - <%= service.getWorkingDays()%></p>-->
                        ...
                        <div class="col-lg-4 ps-lg-2">
                            <div class="sticky-sidebar">
                                ...
                                <% if (loginUserProfile.getWorkJobTitle() != null) {%>
                                <div class="card mb-3">
                                    <div class="card-header bg-light">
                                        <h5 class="mb-0">Experience</h5>
                                    </div>
                                    <div class="card-body fs--1">
                                        <div class="d-flex"><a href="#!"> <img class="img-fluid" src="../assets/img/logos/work.png" alt="" width="56" /></a>
                                            <div class="flex-1 position-relative ps-3">
                                                <h6 class="fs-0 mb-0"><%= loginUserProfile.getWorkJobTitle()%><span data-bs-toggle="tooltip" data-bs-placement="top" title="Verified"><small class="fa fa-check-circle text-primary" data-fa-transform="shrink-4 down-2"></small></span></h6>
                                                <p class="mb-1"><%= loginUserProfile.getWorkCompanyName()%>, <%= loginUserProfile.getWorkJobLocation()%></p>
                                                <p class="text-1000 mb-0">Experience - <%= loginUserProfile.getWorkExperienceYear()%> yrs</p>
                                                <p class="text-1000 mb-0"><%= loginUserProfile.getWorkJobDescription()%></p>
                                                <div class="border-dashed-bottom my-3"></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <% if (loginUserProfile.getEducationFieldStudy() != null && loginUserProfile.getEducationSchoolName() != null) { %>
                                <div class="card mb-3">
                                    <div class="card-header bg-light">
                                    ...
                                    <div class="card-body fs--1">
                                        <div class="d-flex"><a href="#!">
                                                <div class="avatar avatar-3xl">
                                                    <%
                                                        String abbrevation = "EU";
                                                        if (loginUserProfile.getEducationSchoolName() != null) {
                                                            String[] schoolName = loginUserProfile.getEducationSchoolName().split(" ");
                                                            abbrevation = schoolName[0].charAt(0) + "";
                                                            if (schoolName.length > 1) {
                                                                abbrevation += schoolName[schoolName.length - 1].charAt(0);
                                                            }
                                                        }
                                                    %>
                                                    <div class="avatar-name rounded-circle"><span><%= abbrevation%></span></div>
                                                </div>
                                            </a>
                                            <div class="flex-1 position-relative ps-3">
                                                <h6 class="fs-0 mb-0"><%= loginUserProfile.getEducationSchoolName()%><span data-bs-toggle="tooltip" data-bs-placement="top" title="Verified"><small class="fa fa-check-circle text-primary" data-fa-transform="shrink-4 down-2"></small></span></h6>
                                                <p class="mb-1"><%= loginUserProfile.getEducationDegree()%> - <%= loginUserProfile.getEducationFieldStudy()%></p>
                                                <p class="text-1000 mb-0"><%= loginUserProfile.getEducationGraduationDate()%></p>
                                                <p class="text-1000 mb-0"><%= loginUserProfile.getEducationCity()%>, <%= loginUserProfile.getEducationState()%></p>
                                                <div class="border-dashed-bottom my-3"></div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <!--                                <div class="card mb-3 mb-lg-0">
                                                                    ...
                                                                    <div class="card-body fs--1">
                                                                        ...
                                                                        <div class="d-flex btn-reveal-trigger">
                                                                            ...
                                                                            <div class="flex-1 position-relative ps-3">
                                                                                <h6 class="fs-0 mb-0"><a href="../events/event-detail.html">Folk Festival</a></h6>
                                                                    ...
                                                                    <div class="card-footer bg-light p-0 border-top"><a class="btn btn-link d-block w-100" href="../events/event-list.html">All Events<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
                                                                </div>-->
                            </div>
                        </div>
                    </div>
                    ...
                    <!--                    <div class="card mt-3">
                                            <div class="card-header bg-light">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col text-end"><a class="font-sans-serif" href="people.html">All Members</a></div>
                                                </div>
                                            </div>
    ...
    <!-- Mirrored from prium.github.io/falcon/v3.0.0-beta4/social/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 19 Mar 2021 07:24:46 GMT -->
</html>