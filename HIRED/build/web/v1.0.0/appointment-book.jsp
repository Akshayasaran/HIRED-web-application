...
<html lang="en-US" dir="ltr">
    ...
    <body>
        ...
        <%
            ...
            String serviceTime = "", serviceDate = "", serviceComment = "";
            if (appointmentOperation.equals("modify")) {
                Appointment appointment = Appointment.getAppointmentById(providerId, loginUser, serviceId);
                if (appointment != null) {
                    serviceTime = String.valueOf(appointment.getTime());
                    serviceDate = String.valueOf(appointment.getDate());
                    serviceComment = String.valueOf(appointment.getComment());
                }
            }
        %>
                    ...
                    <div class="col-lg-12">
                        <div class="card h-100">
                            ...
                            <div class="card-body bg-light pb-0">
                                <form class="row g-3 needs-validation" novalidate="" action="<%= request.getContextPath()%>/BookAppointment" method="POST">
                                    <input type="hidden" name="appointment-operation" id="appointment-operation" value="<%= appointmentOperation%>">
                                    <input type="hidden" name="receiver-id" id="receiver-id" value="<%= loginUser%>">
                                    <input type="hidden" name="service-id" id="service-id" value="<%= serviceId%>">
                                    <div class="mb-3"><label class="form-label" for="service-name">Service Name</label><input
                                            class="form-control" type="text" name="service-name" id="service-name" placeholder="Service Name"
                                            required="" readonly="readonly" value="<%= serviceName%>" />
                                        <div class="invalid-feedback">Please provide a Service Name.</div>
                                    </div>
                                    <input type="hidden" name="service-provider-id" id="service-provider-id" value="<%= providerId%>">
                                    <div class="mb-3"><label class="form-label" for="provider-name">Provider Name</label><input
                                            class="form-control" type="text" name="provider-name" placeholder="Provider Name" id="provider-name"
                                            required="required" readonly="readonly" value="<%= providerName%>" >
                                        <div class="invalid-feedback">Please provide a Provider Name.</div>
                                    </div>
                                    <div class="row g-2 mt-2">
                                        <div class="col-6 mb-3"><label class="form-label" for="service-time">Time</label>
                                            <input class="form-control datetimepicker" id="service-time" name="service-time" type="text"
                                                   placeholder="H:i" required="required"
                                        ...
                                        <div class="col-6 mb-3"><label class="form-label" for="service-date">Date</label>
                                            <input class="form-control datetimepicker flatpickr-input" type="text" placeholder="yyyy-mm-dd"
                                                   ...
                                                   id="service-date" name="service-date" readonly="readonly" required="required">
                                            <div class="invalid-feedback">Please select a Date</div>
                                        </div>
                                    </div>
                                    <div class="mb-3"><label class="form-label" for="service-comment">Comment</label><textarea
                                            class="form-control" rows="4" id="service-comment" name="service-comment"><%= serviceComment %></textarea></div>
                                    <div class="mb-3">
                                        <div class="row g-2 mt-2">
                                            <div class="col-6">
                                                <button class="btn btn-outline-primary d-block w-100 mt-3" type="reset"
                                                        name="cancel-button">Cancel</button>
                                            </div>
                                            <div class="col-6">
                                                <button class="btn btn-primary d-block w-100 mt-3" type="submit"
                                                        name="book-appointment-button">Book</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
